...
import { 小米挖孔机盖事件MainBody } from "./小米挖孔机盖事件MainBody";
import { 小米挖孔机盖事件ProgressBar, 小米挖孔机盖事件TopStaticHeadline } from "./小米挖孔机盖事件VerticalChrome";
import {
    DESIGN_H,
    DESIGN_W,
    ...
    VERTICAL_PLAY_TOP,
    VERTICAL_PLAY_W,
} from "./小米挖孔机盖事件Constants";

/** 竖屏 1080×1920：顶栏 + 中间 16:9 视口 + 进度条 */
export const 小米挖孔机盖事件Vertical: React.FC = () => {
    ...
    return (
        <AbsoluteFill style={{ background: VERTICAL_SHELL_BG }}>
            ...
            />
            <小米挖孔机盖事件TopStaticHeadline canvasW={VERTICAL_CANVAS_W} topBandH={VERTICAL_PLAY_TOP} />
            <div
                style={{
