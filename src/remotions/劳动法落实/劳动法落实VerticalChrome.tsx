...
import { COVER_DURATION_FRAMES, sceneConfigs, TRANSITION_DURATION } from "./劳动法落实Constants";

const FONT_STACK =
    '"PingFang SC", "Microsoft YaHei", "Noto Sans SC", "Source Han Sans SC", sans-serif';

const STATIC_HEADLINE = "劳动法落实论";
const STATIC_HEADLINE_SUBTITLE = "落实劳动法，产业才能升级";
...
export const 劳动法落实TopStaticHeadline: React.FC<TopStaticHeadlineProps> = ({ canvasW, topBandH }) => (
    <div
        style={{
            position: "absolute",
            left: 0,
...
export const 劳动法落实ProgressBar: React.FC = () => {
