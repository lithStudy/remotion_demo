/**
 * 横屏主片 + 竖屏黑边壳双入口，共享 认知偏见沉没成本谬误MainBody。
...
export { 认知偏见沉没成本谬误Landscape as 认知偏见沉没成本谬误 } from "./认知偏见沉没成本谬误Landscape";
export { 认知偏见沉没成本谬误Vertical as 认知偏见沉没成本谬误竖屏 } from "./认知偏见沉没成本谬误Vertical";
