...
import { 华为专利论MainBody } from "./华为专利论MainBody";
import { 华为专利论ProgressBar, 华为专利论TopStaticHeadline } from "./华为专利论VerticalChrome";
import {
    DESIGN_H,
    DESIGN_W,
...
export const 华为专利论Vertical: React.FC = () => {
    ...
    return (
        <AbsoluteFill style={{ background: VERTICAL_SHELL_BG }}>
            ...
            />
            <华为专利论TopStaticHeadline canvasW={VERTICAL_CANVAS_W} topBandH={VERTICAL_PLAY_TOP} />
            <div
                style={{
