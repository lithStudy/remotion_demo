...
import { COVER_DURATION_FRAMES, sceneConfigs, TRANSITION_DURATION } from "./华为制裁论Constants";

const FONT_STACK =
    '"PingFang SC", "Microsoft YaHei", "Noto Sans SC", "Source Han Sans SC", sans-serif';

const STATIC_HEADLINE = "华为制裁论";
...
export const 华为制裁论TopStaticHeadline: React.FC<TopStaticHeadlineProps> = ({ canvasW, topBandH }) => (
    <div
        style={{
            position: "absolute",
            left: 0,
...
export const 华为制裁论ProgressBar: React.FC = () => {
