...
import { 小米营销论ProgressBar, 小米营销论TopStaticHeadline } from "./小米营销论VerticalChrome";
import {
    DESIGN_H,
    DESIGN_W,
...
export const 小米营销论Vertical: React.FC = () => {
    ...
    return (
        <AbsoluteFill style={{ background: VERTICAL_SHELL_BG }}>
            ...
            />
            <小米营销论TopStaticHeadline canvasW={VERTICAL_CANVAS_W} topBandH={VERTICAL_PLAY_TOP} />
            <div
                style={{
