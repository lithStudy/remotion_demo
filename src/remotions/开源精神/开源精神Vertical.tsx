...
import { 开源精神MainBody } from "./开源精神MainBody";
import { 开源精神ProgressBar, 开源精神TopStaticHeadline } from "./开源精神VerticalChrome";
import {
    DESIGN_H,
    DESIGN_W,
...
export const 开源精神Vertical: React.FC = () => {
    ...
    return (
        <AbsoluteFill style={{ background: VERTICAL_SHELL_BG }}>
            ...
            />
            <开源精神TopStaticHeadline canvasW={VERTICAL_CANVAS_W} topBandH={VERTICAL_PLAY_TOP} />
            <div
                style={{
