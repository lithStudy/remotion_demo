...
import { 豆包仙人论ProgressBar, 豆包仙人论TopStaticHeadline } from "./豆包仙人论VerticalChrome";
import {
    DESIGN_H,
    DESIGN_W,
...
export const 豆包仙人论Vertical: React.FC = () => {
    ...
    return (
        <AbsoluteFill style={{ background: VERTICAL_SHELL_BG }}>
            ...
            />
            <豆包仙人论TopStaticHeadline canvasW={VERTICAL_CANVAS_W} topBandH={VERTICAL_PLAY_TOP} />
            <div
                style={{
