...
- 将原始文案按段落/语义分段，每一段作为一个 item 的 text
- text 的内容就是口播时要念的原文，会以字幕形式展示在视频中
- 如果原文某段太长（超过100字），可以拆成2-3个连续的 item，但文字必须是原文的精确片段，不能修改
...
4. imagePrompt 要求：
   ...
   - 绝对不要包含任何文字，只描述视觉画面（文案将以字幕方式叠加显示）
   - 描述要具体、生动，适合AI图片生成
