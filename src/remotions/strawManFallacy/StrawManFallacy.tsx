...
const sceneConfigs = [
    ...
    { name: "scene4", durationInFrames: calculateScene4Duration(), component: Scene4 },     // P4: 案例二（自动计算）
    { name: "scene5", durationInFrames: calculateScene5Duration(), component: Scene5 },     // P5: 案例三（自动计算）
    { name: "scene6", durationInFrames: calculateScene6Duration(), component: Scene6 }      // P6: 总结场景（自动计算）
];
...
const transitionConfigs = [
    ...
    { type: "fade" as const },      // Scene3 -> Scene4: 淡入淡出
    { type: "fade" as const },      // Scene4 -> Scene5: 淡入淡出
    { type: "fade" as const },      // Scene5 -> Scene6: 淡入淡出
];
