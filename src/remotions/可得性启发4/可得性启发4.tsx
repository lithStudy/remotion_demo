...
export const 可得性启发4Schema = z.object({});

const TRANSITION_DURATION = 15;
const SCENE_END_PADDING = 20;

const sceneConfigs = [
    { name: "scene1", duration: calculateScene1Duration() + SCENE_END_PADDING, component: Scene1, label: "引出问题：常见的信息恐慌" },
    { name: "scene2", duration: calculateScene2Duration() + SCENE_END_PADDING, component: Scene2, label: "剖析原因：媒体算法与大脑偏见" },
    { name: "scene3", duration: calculateScene3Duration() + SCENE_END_PADDING, component: Scene3, label: "解释原理：可得性启发偏见" },
    { name: "scene4", duration: calculateScene4Duration() + SCENE_END_PADDING, component: Scene4, label: "给出方案：防御锦囊" },
    { name: "scene5", duration: calculateScene5Duration() + SCENE_END_PADDING, component: Scene5, label: "总结升华：掌控大脑，自我保护" },
];

export const TOTAL_DURATION_可得性启发4 =
...
export const 可得性启发4: React.FC<z.infer<typeof 可得性启发4Schema>> = () => {
    const frame = useCurrentFrame();
