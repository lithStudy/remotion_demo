...
import { 为雷军正名ProgressBar, 为雷军正名TopStaticHeadline } from "./为雷军正名VerticalChrome";
import {
    DESIGN_H,
    DESIGN_W,
...
export const 为雷军正名Vertical: React.FC = () => {
    ...
    return (
        <AbsoluteFill style={{ background: VERTICAL_SHELL_BG }}>
            ...
            />
            <为雷军正名TopStaticHeadline canvasW={VERTICAL_CANVAS_W} topBandH={VERTICAL_PLAY_TOP} />
            <div
                style={{
