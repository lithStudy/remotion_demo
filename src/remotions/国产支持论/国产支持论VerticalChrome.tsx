...
import { COVER_DURATION_FRAMES, sceneConfigs, TRANSITION_DURATION } from "./国产支持论Constants";

const FONT_STACK =
    '"PingFang SC", "Microsoft YaHei", "Noto Sans SC", "Source Han Sans SC", sans-serif';

const STATIC_HEADLINE = "国产支持论";
...
export const 国产支持论TopStaticHeadline: React.FC<TopStaticHeadlineProps> = ({ canvasW, topBandH }) => (
    <div
        style={{
            position: "absolute",
            left: 0,
...
export const 国产支持论ProgressBar: React.FC = () => {
