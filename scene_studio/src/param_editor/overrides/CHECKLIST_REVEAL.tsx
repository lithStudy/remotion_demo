...
function ChecklistRevealRowsEditor({
	name,
	schema,
	value,
	onChange,
...
// description hint kept for AI: "清单行；showFrom 为 content 下标（0-based），在该条 startFrame 打勾显现"

export const template = "CHECKLIST_REVEAL";
export const fieldOverrides = {
	rows: ChecklistRevealRowsEditor,
};
