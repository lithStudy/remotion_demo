...
export const Ai普惠执剑人MainBody: React.FC = () => (
    <>
        ...
        <Sequence from={COVER_DURATION_FRAMES} durationInFrames={MAIN_DURATION_AI普惠执剑人}>
            <AbsoluteFill>
                <TransitionSeries>
