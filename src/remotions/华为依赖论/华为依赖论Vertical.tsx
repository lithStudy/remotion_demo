...
import { 华为依赖论MainBody } from "./华为依赖论MainBody";
import { 华为依赖论ProgressBar, 华为依赖论TopStaticHeadline } from "./华为依赖论VerticalChrome";
import {
    DESIGN_H,
    DESIGN_W,
...
export const 华为依赖论Vertical: React.FC = () => {
    ...
    return (
        <AbsoluteFill style={{ background: VERTICAL_SHELL_BG }}>
            ...
            />
            <华为依赖论TopStaticHeadline canvasW={VERTICAL_CANVAS_W} topBandH={VERTICAL_PLAY_TOP} />
            <div
                style={{
