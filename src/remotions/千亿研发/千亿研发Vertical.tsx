...
import { 千亿研发MainBody } from "./千亿研发MainBody";
import { 千亿研发ProgressBar, 千亿研发TopStaticHeadline } from "./千亿研发VerticalChrome";
import {
    DESIGN_H,
    DESIGN_W,
...
export const 千亿研发Vertical: React.FC = () => {
    ...
    return (
        <AbsoluteFill style={{ background: VERTICAL_SHELL_BG }}>
            ...
            />
            <千亿研发TopStaticHeadline canvasW={VERTICAL_CANVAS_W} topBandH={VERTICAL_PLAY_TOP} />
            <div
                style={{
