...
export const 可得性启发3Schema = z.object({});
...
const sceneConfigs = [
    ...
    { name: "scene2", duration: calculateScene2Duration() + SCENE_END_PADDING, component: Scene2, label: "剖析信息茧房的成因" },
    { name: "scene3", duration: calculateScene3Duration() + SCENE_END_PADDING, component: Scene3, label: "解释可得性启发偏见" },
    { name: "scene4", duration: calculateScene4Duration() + SCENE_END_PADDING, component: Scene4, label: "提供防御策略" },
    { name: "scene5", duration: calculateScene5Duration() + SCENE_END_PADDING, component: Scene5, label: "总结与升华" },
];

export const TOTAL_DURATION_可得性启发3 =
...
export const 可得性启发3: React.FC<z.infer<typeof 可得性启发3Schema>> = () => {
    const frame = useCurrentFrame();
