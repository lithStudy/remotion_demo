...
import { BWCenterFocus, BWConceptCard, BWSplitCompare } from "../../../components";
    ...
    return (
        <AbsoluteFill>
            ...
            <Sequence from={193} durationInFrames={154}>
                <BWSplitCompare content={[{"text": "你想啊，", "startFrame": 0, "durationFrames": 30}, {"text": "为了博眼球，", "startFrame": 30, "durationFrames": 30}, {"text": "媒体永远只会放大报道极端事件，", "startFrame": 60, "durationFrames": 33}, {"text": "“安全到达”永远上不了热搜，", "startFrame": 93, "durationFrames": 31}, {"text": "“机毁人亡”才会全网推送。", "startFrame": 124, "durationFrames": 30}]} totalDurationFrames={154} leftSrc={staticFile("images/template/scene1_1.png")} rightSrc={staticFile("images/template/scene1_1.png")} leftLabel={"博眼球"} rightLabel={"真实现状"} anchors={[]} />
            </Sequence>
            <Sequence from={347} durationInFrames={120}>
                <BWCenterFocus content={[{"text": "再加上现在的算法，", "startFrame": 0, "durationFrames": 30}, {"text": "你越是害怕、", "startFrame": 30, "durationFrames": 30}, {"text": "越是愤怒多看了一眼，", "startFrame": 60, "durationFrames": 30}, {"text": "它就越是铺天盖地给你推。", "startFrame": 90, "durationFrames": 30}]} totalDurationFrames={120} imageSrc={staticFile("images/template/scene1_1.png")} enterEffect="zoomIn" anchors={[]} />
            </Sequence>
            <Sequence from={467} durationInFrames={126}>
                <BWConceptCard content={[{"text": "这其实是一套把人性弱点研究到极致的注意力收割术，", "startFrame": 0, "durationFrames": 53}, {"text": "咱们普通人就是这样不知不觉被困在了一个人为制造的“信息恐怖屋”里。", "startFrame": 53, "durationFrames": 73}]} totalDurationFrames={126} imageSrc={staticFile("images/template/scene1_1.png")} conceptName={"信息恐怖屋"} anchors={[]} />
            </Sequence>
