...
import { COVER_DURATION_FRAMES, sceneConfigs, TRANSITION_DURATION } from "./大模型先驱论Constants";

const FONT_STACK =
    '"PingFang SC", "Microsoft YaHei", "Noto Sans SC", "Source Han Sans SC", sans-serif';

const STATIC_HEADLINE = "大模型先驱论";
...
export const 大模型先驱论TopStaticHeadline: React.FC<TopStaticHeadlineProps> = ({ canvasW, topBandH }) => (
    <div
        style={{
            position: "absolute",
            left: 0,
...
export const 大模型先驱论ProgressBar: React.FC = () => {
