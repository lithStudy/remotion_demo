...
export const Test5Schema = z.object({});

const TRANSITION_DURATION = 15;
const SCENE_END_PADDING = 20;

const sceneConfigs = [
    { name: "scene1", duration: calculateScene1Duration() + SCENE_END_PADDING, component: Scene1, label: "引出现象：网络环境的负面影响" },
    { name: "scene2", duration: calculateScene2Duration() + SCENE_END_PADDING, component: Scene2, label: "剖析原因：算法与大脑的底层Bug" },
    { name: "scene3", duration: calculateScene3Duration() + SCENE_END_PADDING, component: Scene3, label: "解释概念：确认偏误的运作方式" },
    { name: "scene4", duration: calculateScene4Duration() + SCENE_END_PADDING, component: Scene4, label: "提供方法：应对确认偏误的建议" },
];

export const TOTAL_DURATION_TEST5 =
...
export const Test5: React.FC<z.infer<typeof Test5Schema>> = () => {
    const frame = useCurrentFrame();
