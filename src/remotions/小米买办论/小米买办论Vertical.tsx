...
import { 小米买办论MainBody } from "./小米买办论MainBody";
import { 小米买办论ProgressBar, 小米买办论TopStaticHeadline } from "./小米买办论VerticalChrome";
import {
    DESIGN_H,
    DESIGN_W,
...
export const 小米买办论Vertical: React.FC = () => {
    ...
    return (
        <AbsoluteFill style={{ background: VERTICAL_SHELL_BG }}>
            ...
            />
            <小米买办论TopStaticHeadline canvasW={VERTICAL_CANVAS_W} topBandH={VERTICAL_PLAY_TOP} />
            <div
                style={{
