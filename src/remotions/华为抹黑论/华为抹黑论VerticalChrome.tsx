...
import { COVER_DURATION_FRAMES, sceneConfigs, TRANSITION_DURATION } from "./华为抹黑论Constants";

const FONT_STACK =
    '"PingFang SC", "Microsoft YaHei", "Noto Sans SC", "Source Han Sans SC", sans-serif';

const STATIC_HEADLINE = "华为抹黑论";
const STATIC_HEADLINE_SUBTITLE = "分清楚抹黑与陈述事实";
const STATIC_HEADLINE_SUB = "日常调侃";
const STATIC_HEADLINE_SUB_EN = "DAILY TAKE";
const THEME_ACCENT = "#F59E0B";
const THEME_ACCENT_SOFT = "#F59E0BD9";
...
export const 华为抹黑论TopStaticHeadline: React.FC<TopStaticHeadlineProps> = ({ canvasW, topBandH }) => (
    <div
        style={{
            position: "absolute",
            left: 0,
...
export const 华为抹黑论ProgressBar: React.FC = () => {
