...
function CaseBreakdownPhasesEditor({
	name,
	schema,
	value,
	onChange,
...
// description hint kept for AI: "叙事阶段；每项含 phaseLabel 与 showFrom；showFrom 为 content 下标（0-based，非帧数），须在 0～(content 条数-1) 内"

export const template = "CASE_BREAKDOWN";
export const fieldOverrides = {
	phases: CaseBreakdownPhasesEditor,
};
