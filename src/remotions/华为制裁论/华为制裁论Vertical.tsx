...
import { 华为制裁论MainBody } from "./华为制裁论MainBody";
import { 华为制裁论ProgressBar, 华为制裁论TopStaticHeadline } from "./华为制裁论VerticalChrome";
import {
    DESIGN_H,
    DESIGN_W,
...
export const 华为制裁论Vertical: React.FC = () => {
    ...
    return (
        <AbsoluteFill style={{ background: VERTICAL_SHELL_BG }}>
            ...
            />
            <华为制裁论TopStaticHeadline canvasW={VERTICAL_CANVAS_W} topBandH={VERTICAL_PLAY_TOP} />
            <div
                style={{
