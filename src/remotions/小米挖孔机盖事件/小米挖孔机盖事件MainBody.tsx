...
export const 小米挖孔机盖事件MainBody: React.FC = () => (
    <>
        ...
        <Sequence from={COVER_DURATION_FRAMES} durationInFrames={MAIN_DURATION_小米挖孔机盖事件}>
            <AbsoluteFill>
                <TransitionSeries>
