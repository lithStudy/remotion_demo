...
import { 认知陷阱3MainBody } from "./认知陷阱3MainBody";
import { 认知陷阱3ProgressBar, 认知陷阱3TopStaticHeadline } from "./认知陷阱3VerticalChrome";
import {
    DESIGN_H,
    DESIGN_W,
...
export const 认知陷阱3Vertical: React.FC = () => {
    ...
    return (
        <AbsoluteFill style={{ background: VERTICAL_SHELL_BG }}>
            ...
            />
            <认知陷阱3TopStaticHeadline canvasW={VERTICAL_CANVAS_W} topBandH={VERTICAL_PLAY_TOP} />
            <div
                style={{
