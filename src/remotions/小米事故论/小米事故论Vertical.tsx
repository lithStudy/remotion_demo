...
import { 小米事故论ProgressBar, 小米事故论TopStaticHeadline } from "./小米事故论VerticalChrome";
import {
    DESIGN_H,
    DESIGN_W,
...
export const 小米事故论Vertical: React.FC = () => {
    ...
    return (
        <AbsoluteFill style={{ background: VERTICAL_SHELL_BG }}>
            ...
            />
            <小米事故论TopStaticHeadline canvasW={VERTICAL_CANVAS_W} topBandH={VERTICAL_PLAY_TOP} />
            <div
                style={{
