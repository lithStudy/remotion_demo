...
import { COVER_DURATION_FRAMES, sceneConfigs, TRANSITION_DURATION } from "./小米买办论Constants";

const FONT_STACK =
    '"PingFang SC", "Microsoft YaHei", "Noto Sans SC", "Source Han Sans SC", sans-serif';

const STATIC_HEADLINE = "小米买办论";
...
export const 小米买办论TopStaticHeadline: React.FC<TopStaticHeadlineProps> = ({ canvasW, topBandH }) => (
    <div
        style={{
            position: "absolute",
            left: 0,
...
export const 小米买办论ProgressBar: React.FC = () => {
