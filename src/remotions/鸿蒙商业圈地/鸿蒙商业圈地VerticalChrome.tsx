...
import { COVER_DURATION_FRAMES, sceneConfigs, TRANSITION_DURATION } from "./鸿蒙商业圈地Constants";

const FONT_STACK =
    '"PingFang SC", "Microsoft YaHei", "Noto Sans SC", "Source Han Sans SC", sans-serif';

const STATIC_HEADLINE = "鸿蒙的遮羞布";
...
export const 鸿蒙商业圈地TopStaticHeadline: React.FC<TopStaticHeadlineProps> = ({ canvasW, topBandH }) => (
    <div
        style={{
            position: "absolute",
            left: 0,
...
export const 鸿蒙商业圈地ProgressBar: React.FC = () => {
