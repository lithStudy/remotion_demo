...
import { COVER_DURATION_FRAMES, sceneConfigs, TRANSITION_DURATION } from "./千亿研发Constants";

const FONT_STACK =
    '"PingFang SC", "Microsoft YaHei", "Noto Sans SC", "Source Han Sans SC", sans-serif';

const STATIC_HEADLINE = "千亿研发";
const STATIC_HEADLINE_SUBTITLE = "吹牛嘛，谁不会？";
...
export const 千亿研发TopStaticHeadline: React.FC<TopStaticHeadlineProps> = ({ canvasW, topBandH }) => (
    <div
        style={{
            position: "absolute",
            left: 0,
...
export const 千亿研发ProgressBar: React.FC = () => {
