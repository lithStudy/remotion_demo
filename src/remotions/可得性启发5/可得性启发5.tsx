...
export const 可得性启发5Schema = z.object({});

const TRANSITION_DURATION = 15;
const SCENE_END_PADDING = 20;

const sceneConfigs = [
    { name: "scene1", duration: calculateScene1Duration() + SCENE_END_PADDING, component: Scene1, label: "恐慌情绪的来源" },
...
export const TOTAL_DURATION_可得性启发5 =
...
export const 可得性启发5: React.FC<z.infer<typeof 可得性启发5Schema>> = () => {
    const frame = useCurrentFrame();
