...
export const 智驾论之性价比MainBody: React.FC = () => (
    <>
        ...
        <Sequence from={COVER_DURATION_FRAMES} durationInFrames={MAIN_DURATION_智驾论之性价比}>
            <AbsoluteFill>
                <TransitionSeries>
