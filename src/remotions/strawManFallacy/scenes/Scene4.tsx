        ...
        >
            ...
            >
                ...
                <div style={{ fontSize: 36, color: COLORS.text, lineHeight: 1.6 }}>
                    观点"<HighlightText delay={animationTimings.highlight1.startTime} durationInFrames={animationTimings.highlight1.durationInFrames} highlightColor={COLORS.highlightDefend}>过于暴露</HighlightText>"
            ...
            >
                ...
                <div style={{ fontSize: 36, color: "white", fontStyle: "italic", lineHeight: 1.6 }}>
                    <TypewriterText
                        text="我提议的是'分级'或'适度调整'，不是'全面封建化'。请不要把温和的建议极端化。"
