...
import { 鸿蒙商业圈地ProgressBar, 鸿蒙商业圈地TopStaticHeadline } from "./鸿蒙商业圈地VerticalChrome";
import {
    DESIGN_H,
    DESIGN_W,
    ...
    VERTICAL_PLAY_TOP,
    VERTICAL_PLAY_W,
} from "./鸿蒙商业圈地Constants";

/** 竖屏 1080×1920：顶栏 + 中间 16:9 视口 + 进度条 */
export const 鸿蒙商业圈地Vertical: React.FC = () => {
    ...
    return (
        <AbsoluteFill style={{ background: VERTICAL_SHELL_BG }}>
            ...
            />
            <鸿蒙商业圈地TopStaticHeadline canvasW={VERTICAL_CANVAS_W} topBandH={VERTICAL_PLAY_TOP} />
            <div
                style={{
