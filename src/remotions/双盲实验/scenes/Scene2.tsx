    ...
    return (
        <AbsoluteFill>
            ...
            <Sequence from={178} durationInFrames={196}>
                <BWDosAndDonts content={[{"text": "简单来说，", "startFrame": 0, "durationFrames": 26}, {"text": "如果没有对照组，", "startFrame": 25, "durationFrames": 35}, {"text": "你永远无法证明是你的干预有效，", "startFrame": 60, "durationFrames": 66}, {"text": "还是因为你命大或者身体好。", "startFrame": 125, "durationFrames": 70}]} totalDurationFrames={196} left={{ label: "干预有效", src: staticFile("images/双盲实验/scene_2_2_left.png"), showFrom: 0 }} right={{ label: "命足够大", src: staticFile("images/双盲实验/scene_2_2_right.png"), showFrom: 10 }} />
            </Sequence>
