...
import { COVER_DURATION_FRAMES, sceneConfigs, TRANSITION_DURATION } from "./汽车质量论Constants";
...
export const 汽车质量论TopStaticHeadline: React.FC<TopStaticHeadlineProps> = ({ canvasW, topBandH }) => (
    <div
        style={{
            position: "absolute",
            left: 0,
...
export const 汽车质量论ProgressBar: React.FC = () => {
