...
import { COVER_DURATION_FRAMES, sceneConfigs, TRANSITION_DURATION } from "./智驾论之瓶颈Constants";

const FONT_STACK =
    '"PingFang SC", "Microsoft YaHei", "Noto Sans SC", "Source Han Sans SC", sans-serif';

const STATIC_HEADLINE = "智驾论（一）";
const STATIC_HEADLINE_SUBTITLE = "智驾的胜负手，不在传感器";
...
export const 智驾论之瓶颈TopStaticHeadline: React.FC<TopStaticHeadlineProps> = ({ canvasW, topBandH }) => (
    <div
        style={{
            position: "absolute",
            left: 0,
...
export const 智驾论之瓶颈ProgressBar: React.FC = () => {
