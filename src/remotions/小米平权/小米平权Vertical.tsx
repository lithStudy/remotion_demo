...
import { 小米平权ProgressBar, 小米平权TopStaticHeadline } from "./小米平权VerticalChrome";
import {
    DESIGN_H,
    DESIGN_W,
...
export const 小米平权Vertical: React.FC = () => {
    ...
    return (
        <AbsoluteFill style={{ background: VERTICAL_SHELL_BG }}>
            ...
            />
            <小米平权TopStaticHeadline canvasW={VERTICAL_CANVAS_W} topBandH={VERTICAL_PLAY_TOP} />
            <div
                style={{
