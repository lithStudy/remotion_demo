...
export const BabyProbioticsSchema = z.object({
...
const sceneConfigs = [
    ...
    { name: "scene8", durationInFrames: calculateScene8Duration(), component: Scene8 },
];
 ...
 * 计算总时长
 */
export const TOTAL_DURATION_BABY_PROBIOTICS = sceneConfigs.reduce(
 ...
 * 宝宝益生菌科普动画
 */
export const BabyProbiotics: React.FC<z.infer<typeof BabyProbioticsSchema>> = () => {
    return (
        <AbsoluteFill>
            <TransitionSeries>
