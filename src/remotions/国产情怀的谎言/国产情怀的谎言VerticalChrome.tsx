...
import { COVER_DURATION_FRAMES, sceneConfigs, TRANSITION_DURATION } from "./国产情怀的谎言Constants";

const FONT_STACK =
    '"PingFang SC", "Microsoft YaHei", "Noto Sans SC", "Source Han Sans SC", sans-serif';

const STATIC_HEADLINE = "国产情怀的谎言";
...
export const 国产情怀的谎言TopStaticHeadline: React.FC<TopStaticHeadlineProps> = ({ canvasW, topBandH }) => (
    <div
        style={{
            position: "absolute",
            left: 0,
...
export const 国产情怀的谎言ProgressBar: React.FC = () => {
