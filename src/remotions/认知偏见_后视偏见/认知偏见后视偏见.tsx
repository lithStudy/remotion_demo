...
const sceneConfigs = [
    ...
    { name: "scene3", duration: calculateScene3Duration() + SCENE_END_PADDING, component: Scene3, label: "剖析：生活场景" },
    { name: "scene4", duration: calculateScene4Duration() + SCENE_END_PADDING, component: Scene4, label: "召唤：行动心法" },
];

const MAIN_DURATION_认知偏见_后视偏见 =
...
export const 认知偏见后视偏见: React.FC<z.infer<typeof 认知偏见后视偏见Schema>> = () => {
    const frame = useCurrentFrame();
