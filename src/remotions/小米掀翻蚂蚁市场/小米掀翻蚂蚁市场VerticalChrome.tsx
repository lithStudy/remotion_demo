...
import { COVER_DURATION_FRAMES, sceneConfigs, TRANSITION_DURATION } from "./小米掀翻蚂蚁市场Constants";

const FONT_STACK =
    '"PingFang SC", "Microsoft YaHei", "Noto Sans SC", "Source Han Sans SC", sans-serif';

const STATIC_HEADLINE = "小米掀翻蚂蚁市场";
...
export const 小米掀翻蚂蚁市场TopStaticHeadline: React.FC<TopStaticHeadlineProps> = ({ canvasW, topBandH }) => (
    <div
        style={{
            position: "absolute",
            left: 0,
...
export const 小米掀翻蚂蚁市场ProgressBar: React.FC = () => {
