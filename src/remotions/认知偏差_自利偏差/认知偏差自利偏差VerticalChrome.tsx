...
import { COVER_DURATION_FRAMES, sceneConfigs, TRANSITION_DURATION } from "./认知偏差自利偏差Constants";

const FONT_STACK =
    '"PingFang SC", "Microsoft YaHei", "Noto Sans SC", "Source Han Sans SC", sans-serif';

const STATIC_HEADLINE = "自利偏差";
...
export const 认知偏差自利偏差TopStaticHeadline: React.FC<TopStaticHeadlineProps> = ({ canvasW, topBandH }) => (
    <div
        style={{
            position: "absolute",
            left: 0,
...
export const 认知偏差自利偏差ProgressBar: React.FC = () => {
