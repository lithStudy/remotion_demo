...
import { COVER_DURATION_FRAMES, sceneConfigs, TRANSITION_DURATION } from "./Ai普惠执剑人Constants";

const FONT_STACK =
    '"PingFang SC", "Microsoft YaHei", "Noto Sans SC", "Source Han Sans SC", sans-serif';

const STATIC_HEADLINE = "AI普惠执剑人";
...
export const Ai普惠执剑人TopStaticHeadline: React.FC<TopStaticHeadlineProps> = ({ canvasW, topBandH }) => (
    <div
        style={{
            position: "absolute",
            left: 0,
...
export const Ai普惠执剑人ProgressBar: React.FC = () => {
