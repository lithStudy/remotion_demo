/**
 * 横屏主片 + 竖屏黑边壳双入口，共享 认知偏见可得性启发MainBody。
...
export { 认知偏见可得性启发Landscape as 认知偏见可得性启发 } from "./认知偏见可得性启发Landscape";
export { 认知偏见可得性启发Vertical as 认知偏见可得性启发竖屏 } from "./认知偏见可得性启发Vertical";
