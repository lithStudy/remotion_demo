...
const baseConfigs: AnimationConfig[] = [
    ...
    { name: "scene3_2_0", delayBefore: 0, delayAfter: 0, durationInFrames: 60, preName: "scene3_1_2", audioId: "scene3_2_0" },
    ...
    { name: "scene3_4_0", delayBefore: 0, delayAfter: 20, durationInFrames: 60, preName: "scene3_3_1", audioId: "scene3_4_0" },
];
        ...
        <AbsoluteFill style={{ background: "linear-gradient(180deg, #0d1b2a 0%, #1b2838 100%)" }}>
            ...
            <Sequence from={timings["scene3_1_0"].startTime} durationInFrames={timings["scene3_1_0"].durationInFrames}>
                <div style={{ width: "100%", display: "flex", justifyContent: "center" }}>
                    <div style={{ width: "100%", fontSize: 40, fontWeight: 600, color: "rgba(255,255,255,0.95)", textAlign: "center" as const, lineHeight: 1.4 }}>第一个例子：</div>
                </div>
            </Sequence>
