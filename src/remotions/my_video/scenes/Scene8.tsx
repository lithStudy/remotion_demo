...
const baseConfigs: AnimationConfig[] = [
    ...
    { name: "scene8_1_1", delayBefore: 3, delayAfter: 0, durationInFrames: 60, preName: "scene8_1_0", audioId: "scene8_1_1" },
    { name: "scene8_1_2", delayBefore: 3, delayAfter: 0, durationInFrames: 60, preName: "scene8_1_1", audioId: "scene8_1_2" },
    { name: "scene8_1_3", delayBefore: 3, delayAfter: 0, durationInFrames: 60, preName: "scene8_1_2", audioId: "scene8_1_3" },
    { name: "scene8_2_0", delayBefore: 3, delayAfter: 0, durationInFrames: 60, preName: "scene8_1_3", audioId: "scene8_2_0" },
    { name: "scene8_2_1", delayBefore: 3, delayAfter: 20, durationInFrames: 60, preName: "scene8_2_0", audioId: "scene8_2_1" },
];
        ...
        <AbsoluteFill style={{ background: "linear-gradient(180deg, #1a0000 0%, #2d1f1f 100%)" }}>
            ...
            <Sequence from={timings["scene8_1_0"].startTime} durationInFrames={timings["scene8_1_0"].durationInFrames}>
                <div style={{ width: "100%", display: "flex", justifyContent: "center" }}>
                    <div style={{ width: "100%", fontSize: 40, fontWeight: 600, color: "rgba(255,255,255,0.95)", textAlign: "center" as const, lineHeight: 1.4 }}>让我们总结一下：</div>
                </div>
            </Sequence>
            ...
            <Sequence from={timings["scene8_1_1"].startTime} durationInFrames={timings["scene8_1_1"].durationInFrames}>
                <div style={{ width: "100%", display: "flex", justifyContent: "center" }}>
                    <div style={{ width: "100%", fontSize: 40, fontWeight: 600, color: "rgba(255,255,255,0.95)", textAlign: "center" as const, lineHeight: 1.4 }}>由于伊美过去的恩怨导致了互相防备</div>
                </div>
            </Sequence>
            ...
            <Sequence from={timings["scene8_1_2"].startTime} durationInFrames={timings["scene8_1_2"].durationInFrames}>
                <div style={{ width: "100%", display: "flex", justifyContent: "center" }}>
                    <div style={{ width: "100%", fontSize: 40, fontWeight: 600, color: "rgba(255,255,255,0.95)", textAlign: "center" as const, lineHeight: 1.4 }}>而伊朗研究核武器让美国感觉到了威胁</div>
                </div>
            </Sequence>
            ...
            <Sequence from={timings["scene8_1_3"].startTime} durationInFrames={timings["scene8_1_3"].durationInFrames}>
                <div style={{ width: "100%", display: "flex", justifyContent: "center" }}>
                    <div style={{ width: "100%", fontSize: 40, fontWeight: 600, color: "rgba(255,255,255,0.95)", textAlign: "center" as const, lineHeight: 1.4 }}>这才是最主要的战争原因</div>
                </div>
            </Sequence>
            ...
            <Sequence from={timings["scene8_2_0"].startTime} durationInFrames={timings["scene8_2_0"].durationInFrames}>
                <div style={{ width: "100%", display: "flex", justifyContent: "center" }}>
                    <div style={{ width: "100%", fontSize: 40, fontWeight: 600, color: "rgba(255,255,255,0.95)", textAlign: "center" as const, lineHeight: 1.4 }}>站在彼此的角度我们无法说明谁对谁错</div>
                </div>
            </Sequence>
            ...
            <Sequence from={timings["scene8_2_1"].startTime} durationInFrames={timings["scene8_2_1"].durationInFrames}>
                <div style={{ width: "100%", display: "flex", justifyContent: "center" }}>
                    <div style={{ width: "100%", fontSize: 40, fontWeight: 600, color: "rgba(255,255,255,0.95)", textAlign: "center" as const, lineHeight: 1.4 }}>但我们希望世界永远和平~</div>
                </div>
            </Sequence>
            </div>
