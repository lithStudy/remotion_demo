...
import { COVER_DURATION_FRAMES, sceneConfigs, TRANSITION_DURATION } from "./小米挖孔机盖事件Constants";

const FONT_STACK =
    '"PingFang SC", "Microsoft YaHei", "Noto Sans SC", "Source Han Sans SC", sans-serif';

const STATIC_HEADLINE = "小米挖孔机盖事件";
...
export const 小米挖孔机盖事件TopStaticHeadline: React.FC<TopStaticHeadlineProps> = ({ canvasW, topBandH }) => (
    <div
        style={{
            position: "absolute",
            left: 0,
...
export const 小米挖孔机盖事件ProgressBar: React.FC = () => {
