...
import { 劳动法落实ProgressBar, 劳动法落实TopStaticHeadline } from "./劳动法落实VerticalChrome";
import {
    DESIGN_H,
    DESIGN_W,
...
export const 劳动法落实Vertical: React.FC = () => {
    ...
    return (
        <AbsoluteFill style={{ background: VERTICAL_SHELL_BG }}>
            ...
            />
            <劳动法落实TopStaticHeadline canvasW={VERTICAL_CANVAS_W} topBandH={VERTICAL_PLAY_TOP} />
            <div
                style={{
