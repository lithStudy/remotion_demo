...
export const StatisticTest5Schema = z.object({});

const sceneConfigs = [
    { name: "scene1", duration: calculateScene1Duration(), component: Scene1, label: "开场：数据恐慌" },
    { name: "scene2", duration: calculateScene2Duration(), component: Scene2, label: "基数的重要性：小基数的陷阱" },
    { name: "scene3", duration: calculateScene3Duration(), component: Scene3, label: "比例的迷惑性：大基数的真相" },
    { name: "scene4", duration: calculateScene4Duration(), component: Scene4, label: "比例与基数的比喻" },
    { name: "scene5", duration: calculateScene5Duration(), component: Scene5, label: "广告中的陷阱" },
    { name: "scene6", duration: calculateScene6Duration(), component: Scene6, label: "新闻标题的套路" },
    { name: "scene7", duration: calculateScene7Duration(), component: Scene7, label: "总结：理性思考" },
    { name: "scene8", duration: calculateScene8Duration(), component: Scene8, label: "结尾：保持警惕" },
];

const TRANSITION_DURATION = 15;

export const TOTAL_DURATION_STATISTIC_TEST_5 =
...
export const StatisticTest5: React.FC<z.infer<typeof StatisticTest5Schema>> = () => {
    return (
        <AbsoluteFill>
            <TransitionSeries>
