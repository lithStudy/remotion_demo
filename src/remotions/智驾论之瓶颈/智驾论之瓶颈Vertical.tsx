...
import { 智驾论之瓶颈ProgressBar, 智驾论之瓶颈TopStaticHeadline } from "./智驾论之瓶颈VerticalChrome";
import {
    DESIGN_H,
    DESIGN_W,
...
export const 智驾论之瓶颈Vertical: React.FC = () => {
    ...
    return (
        <AbsoluteFill style={{ background: VERTICAL_SHELL_BG }}>
            ...
            />
            <智驾论之瓶颈TopStaticHeadline canvasW={VERTICAL_CANVAS_W} topBandH={VERTICAL_PLAY_TOP} />
            <div
                style={{
