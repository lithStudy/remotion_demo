...
import { COVER_DURATION_FRAMES, sceneConfigs, TRANSITION_DURATION } from "./认知偏见光环效应Constants";

const FONT_STACK =
    '"PingFang SC", "Microsoft YaHei", "Noto Sans SC", "Source Han Sans SC", sans-serif';

const STATIC_HEADLINE = "光环效应";
...
export const 认知偏见光环效应TopStaticHeadline: React.FC<TopStaticHeadlineProps> = ({ canvasW, topBandH }) => (
    <div
        style={{
            position: "absolute",
            left: 0,
...
export const 认知偏见光环效应ProgressBar: React.FC = () => {
