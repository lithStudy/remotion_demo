...
import { COVER_DURATION_FRAMES, sceneConfigs, TRANSITION_DURATION } from "./权利的边界Constants";

const FONT_STACK =
    '"PingFang SC", "Microsoft YaHei", "Noto Sans SC", "Source Han Sans SC", sans-serif';

const STATIC_HEADLINE = "权利的边界";
...
export const 权利的边界TopStaticHeadline: React.FC<TopStaticHeadlineProps> = ({ canvasW, topBandH }) => (
    <div
        style={{
            position: "absolute",
            left: 0,
...
export const 权利的边界ProgressBar: React.FC = () => {
