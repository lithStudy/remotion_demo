...
import { 搞对立ProgressBar, 搞对立TopStaticHeadline } from "./搞对立VerticalChrome";
import {
    DESIGN_H,
    DESIGN_W,
...
export const 搞对立Vertical: React.FC = () => {
    ...
    return (
        <AbsoluteFill style={{ background: VERTICAL_SHELL_BG }}>
            <搞对立TopStaticHeadline canvasW={VERTICAL_CANVAS_W} topBandH={VERTICAL_PLAY_TOP} />
            <div
                style={{
