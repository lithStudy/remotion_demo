...
export const 国产情怀的谎言MainBody: React.FC = () => (
    <>
        ...
        <Sequence from={COVER_DURATION_FRAMES} durationInFrames={MAIN_DURATION_国产情怀的谎言}>
            <AbsoluteFill>
                <TransitionSeries>
