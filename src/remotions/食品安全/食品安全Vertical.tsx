...
import { 食品安全MainBody } from "./食品安全MainBody";
import { 食品安全ProgressBar, 食品安全TopStaticHeadline } from "./食品安全VerticalChrome";
import {
    DESIGN_H,
    DESIGN_W,
...
export const 食品安全Vertical: React.FC = () => {
    ...
    return (
        <AbsoluteFill style={{ background: VERTICAL_SHELL_BG }}>
            ...
            />
            <食品安全TopStaticHeadline canvasW={VERTICAL_CANVAS_W} topBandH={VERTICAL_PLAY_TOP} />
            <div
                style={{
