    ...
    return (
        <AbsoluteFill>
            <Sequence from={0} durationInFrames={151}>
                <BWDosAndDonts content={[{"text": "我们总以为这是出于谨慎的理性选择，", "startFrame": 0, "durationFrames": 77}, {"text": "但其实我们又被恐惧情绪劫持了。", "startFrame": 76, "durationFrames": 75}]} totalDurationFrames={151} leftSrc={staticFile("images/认知偏见_可得性启发/scene_2_1_left.png")} rightSrc={staticFile("images/认知偏见_可得性启发/scene_2_1_right.png")} dontLabel={"❌ 以为理性"} doLabel={"✅ 恐惧劫持"} />
            </Sequence>
            <Sequence from={151} durationInFrames={128}>
                <BWDosAndDonts content={[{"text": "这不是因为我们胆小怕事，", "startFrame": 0, "durationFrames": 46}, {"text": "而是原始基因刻在骨子里的生存本能。", "startFrame": 45, "durationFrames": 82}]} totalDurationFrames={128} leftSrc={staticFile("images/认知偏见_可得性启发/scene_2_2_left.png")} rightSrc={staticFile("images/认知偏见_可得性启发/scene_2_2_right.png")} dontLabel={"❌ 胆小怕事"} doLabel={"✅ 生存本能"} />
            </Sequence>
