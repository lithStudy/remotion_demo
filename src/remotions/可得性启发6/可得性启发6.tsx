...
export const 可得性启发6Schema = z.object({});

const TRANSITION_DURATION = 15;
const SCENE_END_PADDING = 20;

const sceneConfigs = [
    { name: "scene1", duration: calculateScene1Duration() + SCENE_END_PADDING, component: Scene1, label: "先入为主的偏见" },
    { name: "scene2", duration: calculateScene2Duration() + SCENE_END_PADDING, component: Scene2, label: "底层Bug与流量陷阱" },
    { name: "scene3", duration: calculateScene3Duration() + SCENE_END_PADDING, component: Scene3, label: "可得性启发" },
    { name: "scene4", duration: calculateScene4Duration() + SCENE_END_PADDING, component: Scene4, label: "防御锦囊" },
    { name: "scene5", duration: calculateScene5Duration() + SCENE_END_PADDING, component: Scene5, label: "总结与呼吁" },
];

export const TOTAL_DURATION_可得性启发6 =
...
export const 可得性启发6: React.FC<z.infer<typeof 可得性启发6Schema>> = () => {
    const frame = useCurrentFrame();
