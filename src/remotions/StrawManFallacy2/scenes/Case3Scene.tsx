        ...
        >
            ...
            >
                ...
                <div style={{ fontSize: 36, color: COLORS.text, lineHeight: 1.6 }}>
                    "<HighlightText delay={animationTimings.highlight1} durationInFrames={getConfig("highlight1")?.durationInFrames} highlightColor={COLORS.highlightDefend}>承认差距</HighlightText>"
                    被歪曲为"<HighlightText delay={animationTimings.highlight2} durationInFrames={getConfig("highlight2")?.durationInFrames} highlightColor={COLORS.highlightAttack}>崇洋媚外</HighlightText>"
                    和"<HighlightText delay={animationTimings.highlight3} durationInFrames={getConfig("highlight3")?.durationInFrames} highlightColor={COLORS.highlightAttack}>嫌弃祖国</HighlightText>"。
                </div>
            </div>
