...
export const Statistic2Schema = z.object({});

const sceneConfigs = [
    { name: "scene1", duration: calculateScene1Duration(), component: Scene1, label: "开场：图表的真相" },
    { name: "scene2", duration: calculateScene2Duration(), component: Scene2, label: "截断坐标轴的陷阱" },
    { name: "scene3", duration: calculateScene3Duration(), component: Scene3, label: "图表审计三问" },
    { name: "scene4", duration: calculateScene4Duration(), component: Scene4, label: "招数一：樱桃采摘" },
    { name: "scene5", duration: calculateScene5Duration(), component: Scene5, label: "招数二：3D幻觉" },
    { name: "scene6", duration: calculateScene6Duration(), component: Scene6, label: "招数三：截断Y轴" },
    { name: "scene7", duration: calculateScene7Duration(), component: Scene7, label: "总结与行动" },
];

const TRANSITION_DURATION = 15;

export const TOTAL_DURATION_STATISTIC_2 =
...
export const Statistic2: React.FC<z.infer<typeof Statistic2Schema>> = () => {
    return (
        <AbsoluteFill>
            <TransitionSeries>
