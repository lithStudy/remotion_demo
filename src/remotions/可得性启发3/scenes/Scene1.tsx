    ...
    return (
        <AbsoluteFill>
            ...
            <Sequence from={242} durationInFrames={93}>
                <BWCognitiveShift content={[{"text": "产生这种强烈的恐慌感和焦虑感，", "startFrame": 0, "durationFrames": 33}, {"text": "真不能怪咱们胆小，", "startFrame": 33, "durationFrames": 30}, {"text": "更不是咱们缺乏常识。", "startFrame": 63, "durationFrames": 30}]} totalDurationFrames={93} notText={"胆小"} butText={"信息茧房"} butSrc={staticFile("images/template/scene1_1.png")} notContentIndex={1} butContentIndex={2} anchors={[]} />
            </Sequence>
            ...
            <Sequence from={709} durationInFrames={126}>
                <BWConceptCard content={[{"text": "这其实是一套把人性弱点研究到极致的注意力收割术，", "startFrame": 0, "durationFrames": 53}, {"text": "咱们普通人就是这样不知不觉被困在了一个人为制造的“信息恐怖屋”里。", "startFrame": 53, "durationFrames": 73}]} totalDurationFrames={126} imageSrc={staticFile("images/template/scene1_1.png")} conceptName={"信息茧房"} anchors={[]} />
            </Sequence>
