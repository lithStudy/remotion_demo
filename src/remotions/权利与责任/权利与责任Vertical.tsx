...
import { 权利与责任MainBody } from "./权利与责任MainBody";
import { 权利与责任ProgressBar, 权利与责任TopStaticHeadline } from "./权利与责任VerticalChrome";
import {
    DESIGN_H,
    DESIGN_W,
...
export const 权利与责任Vertical: React.FC = () => {
    ...
    return (
        <AbsoluteFill style={{ background: VERTICAL_SHELL_BG }}>
            ...
            />
            <权利与责任TopStaticHeadline canvasW={VERTICAL_CANVAS_W} topBandH={VERTICAL_PLAY_TOP} />
            <div
                style={{
