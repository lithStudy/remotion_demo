...
const sceneConfigs = [
    ...
    { name: "scene2", duration: calculateScene2Duration() + SCENE_END_PADDING, component: Scene2, label: "揭示本质：算法利用大脑Bug" },
    { name: "scene3", duration: calculateScene3Duration() + SCENE_END_PADDING, component: Scene3, label: "心理学解释：确认偏误的概念" },
    { name: "scene4", duration: calculateScene4Duration() + SCENE_END_PADDING, component: Scene4, label: "提供解决方案：防身武器" },
];

export const TOTAL_DURATION_TEST3 =
...
export const Test3: React.FC<z.infer<typeof Test3Schema>> = () => {
    const frame = useCurrentFrame();
