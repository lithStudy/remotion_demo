...
import { 认知偏见幸存者偏差MainBody } from "./认知偏见幸存者偏差MainBody";
import { 认知偏见幸存者偏差ProgressBar, 认知偏见幸存者偏差TopStaticHeadline } from "./认知偏见幸存者偏差VerticalChrome";
import {
    DESIGN_H,
    DESIGN_W,
...
export const 认知偏见幸存者偏差Vertical: React.FC = () => {
    ...
    return (
        <AbsoluteFill style={{ background: VERTICAL_SHELL_BG }}>
            ...
            />
            <认知偏见幸存者偏差TopStaticHeadline canvasW={VERTICAL_CANVAS_W} topBandH={VERTICAL_PLAY_TOP} />
            <div
                style={{
