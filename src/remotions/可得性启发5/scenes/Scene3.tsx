...
// 防御锦囊
const SCENE_DURATION = 92 + 200 + 151 + 86 + 90;
    ...
    return (
        <AbsoluteFill>
            <Sequence from={0} durationInFrames={92}>
                <BWCenterFocus content={[{"text": "既然知道了大脑的这个Bug，", "startFrame": 0, "durationFrames": 31}, {"text": "咱们以后该怎么保护自己？", "startFrame": 31, "durationFrames": 30}, {"text": "给你两个极低门槛的防御锦囊：", "startFrame": 61, "durationFrames": 31}]} totalDurationFrames={92} imageSrc={staticFile("images/template/scene1_1.png")} enterEffect="fadeIn" anchors={[{"text": "Bug", "showFrom": 0, "color": "#EF4444", "anim": "spring", "audioEffect": "impact_thud"}, {"text": "保护", "showFrom": 1, "color": "#000000", "anim": "slideUp", "audioEffect": "ping"}, {"text": "锦囊", "showFrom": 2, "color": "#000000", "anim": "popIn", "audioEffect": "woosh"}]} />
            </Sequence>
