...
import { 认知偏差基本归因错误MainBody } from "./认知偏差基本归因错误MainBody";
import { 认知偏差基本归因错误ProgressBar, 认知偏差基本归因错误TopStaticHeadline } from "./认知偏差基本归因错误VerticalChrome";
import {
    DESIGN_H,
    DESIGN_W,
    ...
    VERTICAL_PLAY_TOP,
    VERTICAL_PLAY_W,
} from "./认知偏差基本归因错误Constants";

/** 竖屏 1080×1920：顶栏 + 中间 16:9 视口 + 进度条 */
export const 认知偏差基本归因错误Vertical: React.FC = () => {
    ...
    return (
        <AbsoluteFill style={{ background: VERTICAL_SHELL_BG }}>
            ...
            />
            <认知偏差基本归因错误TopStaticHeadline canvasW={VERTICAL_CANVAS_W} topBandH={VERTICAL_PLAY_TOP} />
            <div
                style={{
