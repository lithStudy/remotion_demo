...
import { COVER_DURATION_FRAMES, sceneConfigs, TRANSITION_DURATION } from "./智驾论之性价比Constants";

const FONT_STACK =
    '"PingFang SC", "Microsoft YaHei", "Noto Sans SC", "Source Han Sans SC", sans-serif';

const STATIC_HEADLINE = "智驾论（二）";
const STATIC_HEADLINE_SUBTITLE = "极端天气下，这个车就非开不可吗";
...
export const 智驾论之性价比TopStaticHeadline: React.FC<TopStaticHeadlineProps> = ({ canvasW, topBandH }) => (
    <div
        style={{
            position: "absolute",
            left: 0,
...
export const 智驾论之性价比ProgressBar: React.FC = () => {
