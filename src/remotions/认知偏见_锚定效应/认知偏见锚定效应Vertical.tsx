...
import { 认知偏见锚定效应MainBody } from "./认知偏见锚定效应MainBody";
import { 认知偏见锚定效应ProgressBar, 认知偏见锚定效应TopStaticHeadline } from "./认知偏见锚定效应VerticalChrome";
import {
    DESIGN_H,
    DESIGN_W,
...
export const 认知偏见锚定效应Vertical: React.FC = () => {
    ...
    return (
        <AbsoluteFill style={{ background: VERTICAL_SHELL_BG }}>
            ...
            />
            <认知偏见锚定效应TopStaticHeadline canvasW={VERTICAL_CANVAS_W} topBandH={VERTICAL_PLAY_TOP} />
            <div
                style={{
