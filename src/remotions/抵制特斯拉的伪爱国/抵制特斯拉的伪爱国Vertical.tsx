...
import { 抵制特斯拉的伪爱国ProgressBar, 抵制特斯拉的伪爱国TopStaticHeadline } from "./抵制特斯拉的伪爱国VerticalChrome";
import {
    DESIGN_H,
    DESIGN_W,
...
export const 抵制特斯拉的伪爱国Vertical: React.FC = () => {
    ...
    return (
        <AbsoluteFill style={{ background: VERTICAL_SHELL_BG }}>
            ...
            />
            <抵制特斯拉的伪爱国TopStaticHeadline canvasW={VERTICAL_CANVAS_W} topBandH={VERTICAL_PLAY_TOP} />
            <div
                style={{
