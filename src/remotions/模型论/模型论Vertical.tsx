...
import { 模型论ProgressBar, 模型论TopStaticHeadline } from "./模型论VerticalChrome";
import {
    DESIGN_H,
    DESIGN_W,
...
export const 模型论Vertical: React.FC = () => {
    ...
    return (
        <AbsoluteFill style={{ background: VERTICAL_SHELL_BG }}>
            ...
            />
            <模型论TopStaticHeadline canvasW={VERTICAL_CANVAS_W} topBandH={VERTICAL_PLAY_TOP} />
            <div
                style={{
