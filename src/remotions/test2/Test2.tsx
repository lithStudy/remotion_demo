...
const sceneConfigs = [
    ...
    { name: "scene2", duration: calculateScene2Duration() + SCENE_END_PADDING, component: Scene2, label: "揭示原因：算法与大脑Bug" },
    ...
    { name: "scene5", duration: calculateScene5Duration() + SCENE_END_PADDING, component: Scene5, label: "总结升华：保持清醒与觉醒" },
];

export const TOTAL_DURATION_TEST2 =
...
export const Test2: React.FC<z.infer<typeof Test2Schema>> = () => {
    const frame = useCurrentFrame();
