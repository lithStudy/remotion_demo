    ...
    return (
        <AbsoluteFill>
            ...
            <Sequence from={475} durationInFrames={295}>
                <BWCenterFocus content={[{"text": "这些套路往往把自己包装成", "startFrame": 0, "durationFrames": 55}, {"text": "某种高深莫测的传统智慧或者绝对真理，", "startFrame": 55, "durationFrames": 92}, {"text": "让你觉得如果敢怀疑，", "startFrame": 147, "durationFrames": 53}, {"text": "就是你没文化、", "startFrame": 199, "durationFrames": 30}, {"text": "没情怀，", "startFrame": 229, "durationFrames": 23}, {"text": "甚至是不爱国。", "startFrame": 251, "durationFrames": 43}]} totalDurationFrames={295} imageSrc={staticFile("images/可证伪性/scene_2_3.png")} enterEffect="zoomIn" anchors={[{"text": "情感绑架", "showFrom": 1, "color": "#EF4444", "anim": "spring", "audioEffect": "impact_thud"}, {"text": "不爱国", "showFrom": 4, "color": "#EF4444", "anim": "popIn", "audioEffect": "impact_thud"}]} />
            </Sequence>
