...
export const sceneConfigs = [
    { name: "scene1", duration: calculateScene1Duration() + SCENE_END_PADDING, component: Scene1, label: "引入：畸形绑架" },
    { name: "scene2", duration: calculateScene2Duration() + SCENE_END_PADDING, component: Scene2, label: "揭示：国家扶持真相" },
...
export const TOTAL_DURATION_国产支持论 =
    COVER_DURATION_FRAMES + MAIN_DURATION_国产支持论;
