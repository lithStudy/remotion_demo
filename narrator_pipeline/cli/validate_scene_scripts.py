...
用法（仓库根目录）:
  python -m narrator_pipeline.cli.validate_scene_scripts <scene-scripts.json路径>
"""
...
def main():
    if len(sys.argv) < 2:
        print("用法: python -m narrator_pipeline.cli.validate_scene_scripts <scene-scripts.json>")
        sys.exit(1)
