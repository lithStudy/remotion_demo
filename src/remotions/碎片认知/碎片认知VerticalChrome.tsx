...
import { COVER_DURATION_FRAMES, sceneConfigs, TRANSITION_DURATION } from "./碎片认知Constants";
...
export const 碎片认知TopStaticHeadline: React.FC<TopStaticHeadlineProps> = ({ canvasW, topBandH }) => (
    <div
        style={{
            position: "absolute",
            left: 0,
...
export const 碎片认知ProgressBar: React.FC = () => {
