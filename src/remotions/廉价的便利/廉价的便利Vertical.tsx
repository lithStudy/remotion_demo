...
import { 廉价的便利ProgressBar, 廉价的便利TopStaticHeadline } from "./廉价的便利VerticalChrome";
import {
    DESIGN_H,
    DESIGN_W,
...
export const 廉价的便利Vertical: React.FC = () => {
    ...
    return (
        <AbsoluteFill style={{ background: VERTICAL_SHELL_BG }}>
            <廉价的便利TopStaticHeadline canvasW={VERTICAL_CANVAS_W} topBandH={VERTICAL_PLAY_TOP} />
            <div
                style={{
