...
import { 权利的边界MainBody } from "./权利的边界MainBody";
import { 权利的边界ProgressBar, 权利的边界TopStaticHeadline } from "./权利的边界VerticalChrome";
import {
    DESIGN_H,
    DESIGN_W,
...
export const 权利的边界Vertical: React.FC = () => {
    ...
    return (
        <AbsoluteFill style={{ background: VERTICAL_SHELL_BG }}>
            ...
            />
            <权利的边界TopStaticHeadline canvasW={VERTICAL_CANVAS_W} topBandH={VERTICAL_PLAY_TOP} />
            <div
                style={{
