    ...
    return (
        <AbsoluteFill>
            <Sequence from={0} durationInFrames={155}>
                <BWCenterFocus content={[{"text": "看着那个初中辍学创业、", "startFrame": 0, "durationFrames": 30}, {"text": "如今身价过亿的专访，", "startFrame": 30, "durationFrames": 30}, {"text": "你默默放下了手里正在啃的专业书，", "startFrame": 60, "durationFrames": 35}, {"text": "脑子里冒出一个念头：", "startFrame": 95, "durationFrames": 30}, {"text": "也许读书真的无用。", "startFrame": 125, "durationFrames": 30}]} totalDurationFrames={155} imageSrc={staticFile("一个年轻人看着电脑屏幕，屏幕上显示着创业成功人士的采访")} enterEffect="fadeIn" anchors={[{"text": "辍学创业", "showFrom": 0, "color": "#EF4444", "anim": "spring", "audioEffect": "impact_thud"}, {"text": "读书无用", "showFrom": 4, "color": "#EF4444", "anim": "highlight", "audioEffect": "ping"}]} />
            </Sequence>
