...
import { 华为抹黑论ProgressBar, 华为抹黑论TopStaticHeadline } from "./华为抹黑论VerticalChrome";
import {
    DESIGN_H,
    DESIGN_W,
...
export const 华为抹黑论Vertical: React.FC = () => {
    ...
    return (
        <AbsoluteFill style={{ background: VERTICAL_SHELL_BG }}>
            ...
            />
            <华为抹黑论TopStaticHeadline canvasW={VERTICAL_CANVAS_W} topBandH={VERTICAL_PLAY_TOP} />
            <div
                style={{
