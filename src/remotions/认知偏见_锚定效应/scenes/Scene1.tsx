    ...
    return (
        <AbsoluteFill>
            ...
            <Sequence from={683} durationInFrames={154}>
                <BWCognitiveShift content={[{"text": "这不是因为我们贪图小便宜，", "startFrame": 0, "durationFrames": 57}, {"text": "而是大脑处理信息时存在致命弱点fasdfasdfasdfasdfasdfasdf。", "startFrame": 56, "durationFrames": 97}]} totalDurationFrames={154} notText={"贪图小便宜"} butText={"致命弱点"} butSrc={staticFile("images/认知偏见_锚定效应/scene_1_3.png")} notContentIndex={0} butContentIndex={1} anchors={[]} />
            </Sequence>
