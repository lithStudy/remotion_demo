/**
 * 横屏主片 + 竖屏黑边壳双入口，共享 认知偏见确认偏误MainBody。
...
export { 认知偏见确认偏误Landscape as 认知偏见确认偏误 } from "./认知偏见确认偏误Landscape";
export { 认知偏见确认偏误Vertical as 认知偏见确认偏误竖屏 } from "./认知偏见确认偏误Vertical";
