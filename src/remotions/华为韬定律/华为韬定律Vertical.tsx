...
import { 华为韬定律MainBody } from "./华为韬定律MainBody";
import { 华为韬定律ProgressBar, 华为韬定律TopStaticHeadline } from "./华为韬定律VerticalChrome";
import {
    DESIGN_H,
    DESIGN_W,
...
export const 华为韬定律Vertical: React.FC = () => {
    ...
    return (
        <AbsoluteFill style={{ background: VERTICAL_SHELL_BG }}>
            ...
            />
            <华为韬定律TopStaticHeadline canvasW={VERTICAL_CANVAS_W} topBandH={VERTICAL_PLAY_TOP} />
            <div
                style={{
