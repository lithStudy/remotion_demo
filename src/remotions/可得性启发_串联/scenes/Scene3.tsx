    ...
    return (
        <AbsoluteFill>
            ...
            <Sequence from={90} durationInFrames={136}>
                <BWCognitiveShift content={[{"text": "说人话就是：", "startFrame": 0, "durationFrames": 30}, {"text": "咱们的大脑其实特别偷懒，", "startFrame": 30, "durationFrames": 30}, {"text": "它在判断一件事常不常见时，", "startFrame": 60, "durationFrames": 30}, {"text": "完全取决于这件事在脑子里“好不好想起来”。", "startFrame": 90, "durationFrames": 46}]} totalDurationFrames={136} notText={"特别偷懒"} butText={"取决于脑子里容不容易想起"} butSrc={staticFile("images/template/scene1_1.png")} notContentIndex={1} butContentIndex={3} anchors={[]} />
            </Sequence>
            ...
            <Sequence from={412} durationInFrames={95}>
                <BWStatCompare content={[{"text": "但真实的数据是，", "startFrame": 0, "durationFrames": 30}, {"text": "飞机出事的概率，", "startFrame": 30, "durationFrames": 30}, {"text": "远比你骑电动车被撞的概率低得多。", "startFrame": 60, "durationFrames": 35}]} totalDurationFrames={95} leftValue={1} rightValue={1000000} leftLabel={"飞机出事"} rightLabel={"电动车被撞"} leftSrc={staticFile("images/template/scene1_1.png")} rightSrc={staticFile("images/template/scene1_1.png")} anchors={[]} />
            </Sequence>
            ...
            <Sequence from={598} durationInFrames={127}>
                <BWSplitCompare content={[{"text": "那些极端事件因为充满冲突和血腥，", "startFrame": 0, "durationFrames": 35}, {"text": "记忆点极强；", "startFrame": 35, "durationFrames": 30}, {"text": "而千万次平平无奇的安全起降，", "startFrame": 65, "durationFrames": 31}, {"text": "根本没资格进入你的记忆内存。", "startFrame": 96, "durationFrames": 31}]} totalDurationFrames={127} leftSrc={staticFile("images/template/scene1_1.png")} rightSrc={staticFile("images/template/scene1_1.png")} leftLabel={"极端事件"} rightLabel={"日常起降"} anchors={[]} />
            </Sequence>
