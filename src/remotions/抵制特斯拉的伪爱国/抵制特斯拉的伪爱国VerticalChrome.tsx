...
import { COVER_DURATION_FRAMES, sceneConfigs, TRANSITION_DURATION } from "./抵制特斯拉的伪爱国Constants";

const FONT_STACK =
    '"PingFang SC", "Microsoft YaHei", "Noto Sans SC", "Source Han Sans SC", sans-serif';

const STATIC_HEADLINE = "国之栋梁特斯拉";
...
export const 抵制特斯拉的伪爱国TopStaticHeadline: React.FC<TopStaticHeadlineProps> = ({ canvasW, topBandH }) => (
    <div
        style={{
            position: "absolute",
            left: 0,
...
export const 抵制特斯拉的伪爱国ProgressBar: React.FC = () => {
