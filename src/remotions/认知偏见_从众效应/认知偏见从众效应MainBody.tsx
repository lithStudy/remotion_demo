...
export const 认知偏见从众效应MainBody: React.FC = () => (
    <>
        ...
        <Sequence from={COVER_DURATION_FRAMES} durationInFrames={MAIN_DURATION_认知偏见_从众效应}>
            <AbsoluteFill>
                <TransitionSeries>
