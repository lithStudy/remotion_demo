...
import { 小米掀翻蚂蚁市场ProgressBar, 小米掀翻蚂蚁市场TopStaticHeadline } from "./小米掀翻蚂蚁市场VerticalChrome";
import {
    DESIGN_H,
    DESIGN_W,
...
export const 小米掀翻蚂蚁市场Vertical: React.FC = () => {
    ...
    return (
        <AbsoluteFill style={{ background: VERTICAL_SHELL_BG }}>
            ...
            />
            <小米掀翻蚂蚁市场TopStaticHeadline canvasW={VERTICAL_CANVAS_W} topBandH={VERTICAL_PLAY_TOP} />
            <div
                style={{
