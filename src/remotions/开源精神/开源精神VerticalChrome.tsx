...
import { COVER_DURATION_FRAMES, sceneConfigs, TRANSITION_DURATION } from "./开源精神Constants";

const FONT_STACK =
    '"PingFang SC", "Microsoft YaHei", "Noto Sans SC", "Source Han Sans SC", sans-serif';

const STATIC_HEADLINE = "开源精神";
...
export const 开源精神TopStaticHeadline: React.FC<TopStaticHeadlineProps> = ({ canvasW, topBandH }) => (
    <div
        style={{
            position: "absolute",
            left: 0,
...
export const 开源精神ProgressBar: React.FC = () => {
