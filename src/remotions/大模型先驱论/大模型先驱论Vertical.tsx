...
import { 大模型先驱论ProgressBar, 大模型先驱论TopStaticHeadline } from "./大模型先驱论VerticalChrome";
import {
    DESIGN_H,
    DESIGN_W,
    ...
    VERTICAL_PLAY_TOP,
    VERTICAL_PLAY_W,
} from "./大模型先驱论Constants";

/** 竖屏 1080×1920：顶栏 + 中间 16:9 视口 + 进度条 */
export const 大模型先驱论Vertical: React.FC = () => {
    ...
    return (
        <AbsoluteFill style={{ background: VERTICAL_SHELL_BG }}>
            ...
            />
            <大模型先驱论TopStaticHeadline canvasW={VERTICAL_CANVAS_W} topBandH={VERTICAL_PLAY_TOP} />
            <div
                style={{
