...
const baseConfigs: AnimationConfig[] = [
    ...
    { name: "scene7_2_0", delayBefore: 3, delayAfter: 0, durationInFrames: 60, preName: "scene7_1_1", audioId: "scene7_2_0" },
    { name: "scene7_2_1", delayBefore: 3, delayAfter: 0, durationInFrames: 60, preName: "scene7_2_0", audioId: "scene7_2_1" },
    { name: "scene7_3_0", delayBefore: 3, delayAfter: 20, durationInFrames: 60, preName: "scene7_2_1", audioId: "scene7_3_0" },
];
    ...
    return (
        <AbsoluteFill style={{ background: "linear-gradient(180deg, #0b1d3a 0%, #162447 100%)" }}>
            ...
            <Sequence from={timings["scene7_1_0"].startTime}>
                <Img
                    src={staticFile("images/statistic_2/scene7_1.png")}
                    style={{
                        position: "absolute",
            ...
            <Sequence from={timings["scene7_2_0"].startTime}>
                <Img
                    src={staticFile("images/statistic_2/scene7_2.png")}
                    style={{
                        position: "absolute",
                        width: "100%", height: "100%", objectFit: "cover",
            ...
            <Sequence from={timings["scene7_3_0"].startTime}>
                <Img
                    src={staticFile("images/statistic_2/scene7_3.png")}
                    style={{
                        position: "absolute",
                        width: "100%", height: "100%", objectFit: "cover",
            ...
            <Sequence from={timings["scene7_1_0"].startTime} durationInFrames={timings["scene7_1_0"].durationInFrames}>
                <div style={{ width: "100%", display: "flex", justifyContent: "center" }}>
                    <div style={{ width: "100%", fontSize: 40, fontWeight: 600, color: "rgba(255,255,255,0.95)", textAlign: "center" as const, lineHeight: 1.4 }}>最后总结一下：</div>
                </div>
            </Sequence>
            ...
            <Sequence from={timings["scene7_1_1"].startTime} durationInFrames={timings["scene7_1_1"].durationInFrames}>
                <div style={{ width: "100%", display: "flex", justifyContent: "center" }}>
                    <div style={{ width: "100%", fontSize: 40, fontWeight: 600, color: "rgba(255,255,255,0.95)", textAlign: "center" as const, lineHeight: 1.4 }}>图表本身不会说谎，但作图的人会</div>
                </div>
            </Sequence>
            ...
            <Sequence from={timings["scene7_2_0"].startTime} durationInFrames={timings["scene7_2_0"].durationInFrames}>
                <div style={{ width: "100%", display: "flex", justifyContent: "center" }}>
                    <div style={{ width: "100%", fontSize: 40, fontWeight: 600, color: "rgba(255,255,255,0.95)", textAlign: "center" as const, lineHeight: 1.4 }}>永远检查坐标轴、时间跨度和真实比例</div>
                </div>
            </Sequence>
            ...
            <Sequence from={timings["scene7_2_1"].startTime} durationInFrames={timings["scene7_2_1"].durationInFrames}>
                <div style={{ width: "100%", display: "flex", justifyContent: "center" }}>
                    <div style={{ width: "100%", fontSize: 40, fontWeight: 600, color: "rgba(255,255,255,0.95)", textAlign: "center" as const, lineHeight: 1.4 }}>当你学会审视图表的时候，数据才不敢对你撒谎</div>
                </div>
            </Sequence>
            ...
            <Sequence from={timings["scene7_3_0"].startTime} durationInFrames={timings["scene7_3_0"].durationInFrames}>
                <div style={{ width: "100%", display: "flex", justifyContent: "center" }}>
                    <div style={{ width: "100%", fontSize: 40, fontWeight: 600, color: "rgba(255,255,255,0.95)", textAlign: "center" as const, lineHeight: 1.4 }}>关注我，带你拆穿更多数据背后的真相</div>
                </div>
            </Sequence>
            </div>
