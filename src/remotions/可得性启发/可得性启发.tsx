...
export const 可得性启发Schema = z.object({});

const TRANSITION_DURATION = 15;
const SCENE_END_PADDING = 20;

const sceneConfigs = [
    { name: "scene1", duration: calculateScene1Duration() + SCENE_END_PADDING, component: Scene1, label: "引出恐慌情绪与常见现象" },
    { name: "scene2", duration: calculateScene2Duration() + SCENE_END_PADDING, component: Scene2, label: "剖析恐慌来源：媒体算法与人性弱点" },
    { name: "scene3", duration: calculateScene3Duration() + SCENE_END_PADDING, component: Scene3, label: "解释“可得性启发”偏见" },
    { name: "scene4", duration: calculateScene4Duration() + SCENE_END_PADDING, component: Scene4, label: "提供防御锦囊：警惕情绪画面，用数据对抗直觉" },
    { name: "scene5", duration: calculateScene5Duration() + SCENE_END_PADDING, component: Scene5, label: "总结与升华" },
];

export const TOTAL_DURATION_可得性启发 =
...
export const 可得性启发: React.FC<z.infer<typeof 可得性启发Schema>> = () => {
    const frame = useCurrentFrame();
