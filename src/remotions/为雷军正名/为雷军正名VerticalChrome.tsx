...
import { COVER_DURATION_FRAMES, sceneConfigs, TRANSITION_DURATION } from "./为雷军正名Constants";

const FONT_STACK =
    '"PingFang SC", "Microsoft YaHei", "Noto Sans SC", "Source Han Sans SC", sans-serif';

const STATIC_HEADLINE = "为雷军正名";
...
export const 为雷军正名TopStaticHeadline: React.FC<TopStaticHeadlineProps> = ({ canvasW, topBandH }) => (
    <div
        style={{
            position: "absolute",
            left: 0,
...
export const 为雷军正名ProgressBar: React.FC = () => {
