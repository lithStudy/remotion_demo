...
export const Test6Schema = z.object({});
...
const sceneConfigs = [
    ...
    { name: "scene4", duration: calculateScene4Duration() + SCENE_END_PADDING, component: Scene4, label: "给出建议：对抗偏见的武器" },
];

export const TOTAL_DURATION_TEST6 =
...
export const Test6: React.FC<z.infer<typeof Test6Schema>> = () => {
    const frame = useCurrentFrame();
