...
import { COVER_DURATION_FRAMES, sceneConfigs, TRANSITION_DURATION } from "./爱国先爱同胞Constants";
...
export const 爱国先爱同胞TopStaticHeadline: React.FC<TopStaticHeadlineProps> = ({ canvasW, topBandH }) => (
    <div
        style={{
            position: "absolute",
            left: 0,
...
export const 爱国先爱同胞ProgressBar: React.FC = () => {
