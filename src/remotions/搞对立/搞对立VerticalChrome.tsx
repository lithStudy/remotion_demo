...
import { COVER_DURATION_FRAMES, sceneConfigs, TRANSITION_DURATION } from "./搞对立Constants";
...
export const 搞对立TopStaticHeadline: React.FC<TopStaticHeadlineProps> = ({ canvasW, topBandH }) => (
    <div
        style={{
            position: "absolute",
            left: 0,
...
export const 搞对立ProgressBar: React.FC = () => {
