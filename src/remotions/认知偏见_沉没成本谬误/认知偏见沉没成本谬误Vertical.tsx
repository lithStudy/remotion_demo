...
import { 认知偏见沉没成本谬误MainBody } from "./认知偏见沉没成本谬误MainBody";
import { 认知偏见沉没成本谬误ProgressBar, 认知偏见沉没成本谬误TopStaticHeadline } from "./认知偏见沉没成本谬误VerticalChrome";
import {
    DESIGN_H,
    DESIGN_W,
...
export const 认知偏见沉没成本谬误Vertical: React.FC = () => {
    ...
    return (
        <AbsoluteFill style={{ background: VERTICAL_SHELL_BG }}>
            ...
            />
            <认知偏见沉没成本谬误TopStaticHeadline canvasW={VERTICAL_CANVAS_W} topBandH={VERTICAL_PLAY_TOP} />
            <div
                style={{
