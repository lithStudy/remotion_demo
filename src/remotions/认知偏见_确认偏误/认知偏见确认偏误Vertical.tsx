...
import { 认知偏见确认偏误ProgressBar, 认知偏见确认偏误TopStaticHeadline } from "./认知偏见确认偏误VerticalChrome";
import {
    DESIGN_H,
    DESIGN_W,
    VERTICAL_CANVAS_W,
...
export const 认知偏见确认偏误Vertical: React.FC = () => {
    ...
    return (
        <AbsoluteFill style={{ background: "#000" }}>
            ...
            />
            <认知偏见确认偏误TopStaticHeadline canvasW={VERTICAL_CANVAS_W} topBandH={VERTICAL_PLAY_TOP} />
            <div
                style={{
