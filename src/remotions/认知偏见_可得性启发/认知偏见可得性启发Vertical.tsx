...
import { 认知偏见可得性启发MainBody } from "./认知偏见可得性启发MainBody";
import { 认知偏见可得性启发ProgressBar, 认知偏见可得性启发TopStaticHeadline } from "./认知偏见可得性启发VerticalChrome";
import {
    DESIGN_H,
    DESIGN_W,
...
export const 认知偏见可得性启发Vertical: React.FC = () => {
