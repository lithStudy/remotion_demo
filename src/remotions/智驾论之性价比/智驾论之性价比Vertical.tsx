...
import { 智驾论之性价比MainBody } from "./智驾论之性价比MainBody";
import { 智驾论之性价比ProgressBar, 智驾论之性价比TopStaticHeadline } from "./智驾论之性价比VerticalChrome";
import {
    DESIGN_H,
    DESIGN_W,
    ...
    VERTICAL_PLAY_TOP,
    VERTICAL_PLAY_W,
} from "./智驾论之性价比Constants";

/** 竖屏 1080×1920：顶栏 + 中间 16:9 视口 + 进度条 */
export const 智驾论之性价比Vertical: React.FC = () => {
    ...
    return (
        <AbsoluteFill style={{ background: VERTICAL_SHELL_BG }}>
            ...
            />
            <智驾论之性价比TopStaticHeadline canvasW={VERTICAL_CANVAS_W} topBandH={VERTICAL_PLAY_TOP} />
            <div
                style={{
