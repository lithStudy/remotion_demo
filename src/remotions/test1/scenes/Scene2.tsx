    ...
    return (
        <AbsoluteFill>
            ...
            <Sequence from={100} durationInFrames={90}>
                <BWConceptCard imageSrc={staticFile("一个带有故障或缺陷符号（如裂缝、红叉或破损齿轮）的拟人化大脑图标")} conceptName={"大脑底层Bug"} content={[{"text": "我们的大脑在进化过程中，", "startFrame": 0, "durationFrames": 30, "anchor": null, "anchorColor": null, "anchorAnim": null, "audioEffect": null}, {"text": "保留了一个极其隐蔽的", "startFrame": 30, "durationFrames": 30, "anchor": null, "anchorColor": null, "anchorAnim": null, "audioEffect": null}, {"text": "“底层Bug”，", "startFrame": 60, "durationFrames": 30, "anchor": "底层Bug", "anchorColor": "#EF4444", "anchorAnim": "popIn", "audioEffect": "impact_thud"}]} totalDurationFrames={90} />
            </Sequence>
            ...
            <Sequence from={280} durationInFrames={61}>
                <BWCenterFocus imageSrc={staticFile("一个人被手机屏幕吸引的抽象插画")} enterEffect="breathe" content={[{"text": "那些平台为了让你多刷半小时,", "startFrame": 0, "durationFrames": 31, "anchor": null, "anchorColor": null, "anchorAnim": null, "audioEffect": null}, {"text": "会不断推送你认同的观点。", "startFrame": 31, "durationFrames": 30, "anchor": null, "anchorColor": null, "anchorAnim": null, "audioEffect": null}]} totalDurationFrames={61} />
            </Sequence>
            <Sequence from={341} durationInFrames={90}>
                <BWAlertStyle imageSrc={staticFile("眼神空洞的宠物被关在华丽的笼子里")} enterEffect="fadeIn" content={[{"text": "久而久之，", "startFrame": 0, "durationFrames": 30, "anchor": null, "anchorColor": null, "anchorAnim": null, "audioEffect": null}, {"text": "我们就像被喂食的宠物，", "startFrame": 30, "durationFrames": 30, "anchor": null, "anchorColor": null, "anchorAnim": null, "audioEffect": null}, {"text": "眼中只剩下一片虚假的繁荣。", "startFrame": 60, "durationFrames": 30, "anchor": null, "anchorColor": null, "anchorAnim": null, "audioEffect": null}]} totalDurationFrames={90} />
            </Sequence>
