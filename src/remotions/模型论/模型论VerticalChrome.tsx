...
import { COVER_DURATION_FRAMES, sceneConfigs, TRANSITION_DURATION } from "./模型论Constants";

const FONT_STACK =
    '"PingFang SC", "Microsoft YaHei", "Noto Sans SC", "Source Han Sans SC", sans-serif';

const STATIC_HEADLINE = "模型论";
const STATIC_HEADLINE_SUBTITLE = "重新定义模型";
...
export const 模型论TopStaticHeadline: React.FC<TopStaticHeadlineProps> = ({ canvasW, topBandH }) => (
    <div
        style={{
            position: "absolute",
            left: 0,
...
export const 模型论ProgressBar: React.FC = () => {
