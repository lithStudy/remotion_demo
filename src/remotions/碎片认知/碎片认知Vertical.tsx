...
import { 碎片认知MainBody } from "./碎片认知MainBody";
import { 碎片认知ProgressBar, 碎片认知TopStaticHeadline } from "./碎片认知VerticalChrome";
import {
    DESIGN_H,
    DESIGN_W,
...
export const 碎片认知Vertical: React.FC = () => {
    ...
    return (
        <AbsoluteFill style={{ background: VERTICAL_SHELL_BG }}>
            ...
            />
            <碎片认知TopStaticHeadline canvasW={VERTICAL_CANVAS_W} topBandH={VERTICAL_PLAY_TOP} />
            <div
                style={{
