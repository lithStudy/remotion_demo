...
import { 爱国先爱同胞MainBody } from "./爱国先爱同胞MainBody";
import { 爱国先爱同胞ProgressBar, 爱国先爱同胞TopStaticHeadline } from "./爱国先爱同胞VerticalChrome";
import {
    DESIGN_H,
    DESIGN_W,
...
export const 爱国先爱同胞Vertical: React.FC = () => {
    ...
    return (
        <AbsoluteFill style={{ background: VERTICAL_SHELL_BG }}>
            ...
            />
            <爱国先爱同胞TopStaticHeadline canvasW={VERTICAL_CANVAS_W} topBandH={VERTICAL_PLAY_TOP} />
            <div
                style={{
