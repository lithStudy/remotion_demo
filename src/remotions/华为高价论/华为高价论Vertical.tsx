...
import { 华为高价论MainBody } from "./华为高价论MainBody";
import { 华为高价论ProgressBar, 华为高价论TopStaticHeadline } from "./华为高价论VerticalChrome";
import {
    DESIGN_H,
    DESIGN_W,
...
export const 华为高价论Vertical: React.FC = () => {
    ...
    return (
        <AbsoluteFill style={{ background: VERTICAL_SHELL_BG }}>
            ...
            />
            <华为高价论TopStaticHeadline canvasW={VERTICAL_CANVAS_W} topBandH={VERTICAL_PLAY_TOP} />
            <div
                style={{
