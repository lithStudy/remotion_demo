...
export const 可得性启发串联Schema = z.object({});

const TRANSITION_DURATION = 15;
const SCENE_END_PADDING = 20;

const sceneConfigs = [
    { name: "scene1", duration: calculateScene1Duration() + SCENE_END_PADDING, component: Scene1, label: "引出恐慌感和焦虑感" },
    { name: "scene2", duration: calculateScene2Duration() + SCENE_END_PADDING, component: Scene2, label: "剖析恐慌感来源" },
    { name: "scene3", duration: calculateScene3Duration() + SCENE_END_PADDING, component: Scene3, label: "心理学解释：可得性启发" },
    { name: "scene4", duration: calculateScene4Duration() + SCENE_END_PADDING, component: Scene4, label: "提供防御方法" },
];

export const TOTAL_DURATION_可得性启发_串联 =
...
export const 可得性启发串联: React.FC<z.infer<typeof 可得性启发串联Schema>> = () => {
    const frame = useCurrentFrame();
