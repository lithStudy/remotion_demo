...
export const 鸿蒙商业圈地MainBody: React.FC = () => (
    <>
        ...
        <Sequence from={COVER_DURATION_FRAMES} durationInFrames={MAIN_DURATION_鸿蒙商业圈地}>
            <AbsoluteFill>
                <TransitionSeries>
