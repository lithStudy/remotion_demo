...
import { COVER_DURATION_FRAMES, sceneConfigs, TRANSITION_DURATION } from "./华为的5g迷思Constants";
...
export const 华为的5g迷思TopStaticHeadline: React.FC<TopStaticHeadlineProps> = ({ canvasW, topBandH }) => (
    <div
        style={{
            position: "absolute",
            left: 0,
...
export const 华为的5g迷思ProgressBar: React.FC = () => {
