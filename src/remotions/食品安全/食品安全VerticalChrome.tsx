...
import { COVER_DURATION_FRAMES, sceneConfigs, TRANSITION_DURATION } from "./食品安全Constants";
...
export const 食品安全TopStaticHeadline: React.FC<TopStaticHeadlineProps> = ({ canvasW, topBandH }) => (
    <div
        style={{
            position: "absolute",
            left: 0,
...
export const 食品安全ProgressBar: React.FC = () => {
