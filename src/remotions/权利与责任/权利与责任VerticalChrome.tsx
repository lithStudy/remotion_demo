...
import { COVER_DURATION_FRAMES, sceneConfigs, TRANSITION_DURATION } from "./权利与责任Constants";

const FONT_STACK =
    '"PingFang SC", "Microsoft YaHei", "Noto Sans SC", "Source Han Sans SC", sans-serif';

const STATIC_HEADLINE = "权利与责任";
const STATIC_HEADLINE_SUBTITLE = "秦桧跪了千年，但那个真正该跪的人，你质疑过吗？";
...
export const 权利与责任TopStaticHeadline: React.FC<TopStaticHeadlineProps> = ({ canvasW, topBandH }) => (
    <div
        style={{
            position: "absolute",
            left: 0,
...
export const 权利与责任ProgressBar: React.FC = () => {
