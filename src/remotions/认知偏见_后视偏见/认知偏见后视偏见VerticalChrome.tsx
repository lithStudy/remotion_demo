...
import { COVER_DURATION_FRAMES, sceneConfigs, TRANSITION_DURATION } from "./认知偏见后视偏见Constants";

const FONT_STACK =
    '"PingFang SC", "Microsoft YaHei", "Noto Sans SC", "Source Han Sans SC", sans-serif';

const STATIC_HEADLINE = "后视偏见";
...
export const 认知偏见后视偏见TopStaticHeadline: React.FC<TopStaticHeadlineProps> = ({ canvasW, topBandH }) => (
    <div
        style={{
            position: "absolute",
            left: 0,
