...
import { 智驾兜底论ProgressBar, 智驾兜底论TopStaticHeadline } from "./智驾兜底论VerticalChrome";
import {
    DESIGN_H,
    DESIGN_W,
...
export const 智驾兜底论Vertical: React.FC = () => {
    ...
    return (
        <AbsoluteFill style={{ background: VERTICAL_SHELL_BG }}>
            ...
            />
            <智驾兜底论TopStaticHeadline canvasW={VERTICAL_CANVAS_W} topBandH={VERTICAL_PLAY_TOP} />
            <div
                style={{
