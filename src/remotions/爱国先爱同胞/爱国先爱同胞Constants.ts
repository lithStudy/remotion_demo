...
export const 爱国先爱同胞Schema = z.object({});
...
export const sceneConfigs = [
    { name: "scene1", duration: calculateScene1Duration() + SCENE_END_PADDING, component: Scene1, label: "引入：U型锁事件" },
    { name: "scene2", duration: calculateScene2Duration() + SCENE_END_PADDING, component: Scene2, label: "举证：更多受伤的普通人" },
...
export const TOTAL_DURATION_爱国先爱同胞 =
    COVER_DURATION_FRAMES + MAIN_DURATION_爱国先爱同胞;
