...
export const TOTAL_DURATION_SOURCE_EVALUATION =
...
export const SourceEvaluation: React.FC<z.infer<typeof SourceEvaluationSchema>> = () => {
    return (
        <AbsoluteFill>
            <TransitionSeries>
                <TransitionSeries.Sequence durationInFrames={TOTAL_DURATION_SCIENCE_INTRO}>
                    <ScienceIntro titleText="信息源评估" titleAudio="/audio/sourceEvaluation/scene1/01_主标题.mp3" />
