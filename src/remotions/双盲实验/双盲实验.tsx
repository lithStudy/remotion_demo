...
export const 双盲实验Schema = z.object({});
...
const sceneConfigs = [
    ...
    { name: "scene3", duration: calculateScene3Duration() + SCENE_END_PADDING, component: Scene3, label: "防御性思维" },
...
export const 双盲实验: React.FC<z.infer<typeof 双盲实验Schema>> = () => {
    const frame = useCurrentFrame();
