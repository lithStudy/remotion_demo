...
import { COVER_DURATION_FRAMES, sceneConfigs, TRANSITION_DURATION } from "./廉价的便利Constants";

const FONT_STACK =
    '"PingFang SC", "Microsoft YaHei", "Noto Sans SC", "Source Han Sans SC", sans-serif';

const STATIC_HEADLINE = "廉价的便利";
const STATIC_HEADLINE_SUBTITLE = "廉价的便利，是一记回旋镖";
...
export const 廉价的便利TopStaticHeadline: React.FC<TopStaticHeadlineProps> = ({ canvasW, topBandH }) => (
    <div
        style={{
            position: "absolute",
            left: 0,
...
export const 廉价的便利ProgressBar: React.FC = () => {
