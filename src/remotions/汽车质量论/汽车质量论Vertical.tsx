...
import { 汽车质量论ProgressBar, 汽车质量论TopStaticHeadline } from "./汽车质量论VerticalChrome";
import {
    DESIGN_H,
    DESIGN_W,
...
export const 汽车质量论Vertical: React.FC = () => {
    ...
    return (
        <AbsoluteFill style={{ background: VERTICAL_SHELL_BG }}>
            ...
            />
            <汽车质量论TopStaticHeadline canvasW={VERTICAL_CANVAS_W} topBandH={VERTICAL_PLAY_TOP} />
            <div
                style={{
