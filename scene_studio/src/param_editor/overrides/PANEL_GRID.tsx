...
function PanelGridPanelsEditor({
	name,
	schema,
	value,
	onChange,
...
// description hint kept for AI: "宫格配图；showFrom 为 content 下标（0-based），在该条 startFrame 显现"

export const template = "PANEL_GRID";
export const fieldOverrides = {
	panels: PanelGridPanelsEditor,
};
