...
import { COVER_DURATION_FRAMES, sceneConfigs, TRANSITION_DURATION } from "./豆包仙人论Constants";

const FONT_STACK =
    '"PingFang SC", "Microsoft YaHei", "Noto Sans SC", "Source Han Sans SC", sans-serif';

const STATIC_HEADLINE = "豆包仙人论";
const STATIC_HEADLINE_SUBTITLE = "豆包不是仙人，是确认偏误放大器";
...
export const 豆包仙人论TopStaticHeadline: React.FC<TopStaticHeadlineProps> = ({ canvasW, topBandH }) => (
    <div
        style={{
            position: "absolute",
            left: 0,
...
export const 豆包仙人论ProgressBar: React.FC = () => {
