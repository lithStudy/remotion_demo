...
import { COVER_DURATION_FRAMES, sceneConfigs, TRANSITION_DURATION } from "./小米核心技术Constants";
...
export const 小米核心技术TopStaticHeadline: React.FC<TopStaticHeadlineProps> = ({ canvasW, topBandH }) => (
    <div
        style={{
            position: "absolute",
            left: 0,
...
export const 小米核心技术ProgressBar: React.FC = () => {
