...
import { COVER_DURATION_FRAMES, sceneConfigs, TRANSITION_DURATION } from "./认知偏见确认偏误Constants";

const FONT_STACK =
    '"PingFang SC", "Microsoft YaHei", "Noto Sans SC", "Source Han Sans SC", sans-serif';

const STATIC_HEADLINE = "确认偏误";
const STATIC_HEADLINE_SUB = "认知偏见";
const STATIC_HEADLINE_SUB_EN = "COGNITIVE BIAS";
...
export const 认知偏见确认偏误TopStaticHeadline: React.FC<TopStaticHeadlineProps> = ({ canvasW, topBandH }) => (
    <div
        style={{
            position: "absolute",
            left: 0,
...
const ConfirmationBiasVerticalProgressBarInner: React.FC = () => {
...
export const 认知偏见确认偏误ProgressBar = ConfirmationBiasVerticalProgressBarInner;
