...
import { 国产支持论ProgressBar, 国产支持论TopStaticHeadline } from "./国产支持论VerticalChrome";
import {
    DESIGN_H,
    DESIGN_W,
...
export const 国产支持论Vertical: React.FC = () => {
    ...
    return (
        <AbsoluteFill style={{ background: VERTICAL_SHELL_BG }}>
            ...
            />
            <国产支持论TopStaticHeadline canvasW={VERTICAL_CANVAS_W} topBandH={VERTICAL_PLAY_TOP} />
            <div
                style={{
