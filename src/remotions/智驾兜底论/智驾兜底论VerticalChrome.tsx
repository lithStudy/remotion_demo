...
import { COVER_DURATION_FRAMES, sceneConfigs, TRANSITION_DURATION } from "./智驾兜底论Constants";

const FONT_STACK =
    '"PingFang SC", "Microsoft YaHei", "Noto Sans SC", "Source Han Sans SC", sans-serif';

const STATIC_HEADLINE = "智驾兜底论";
const STATIC_HEADLINE_SUBTITLE = "看着像保障，本质是营销";
...
export const 智驾兜底论TopStaticHeadline: React.FC<TopStaticHeadlineProps> = ({ canvasW, topBandH }) => (
    <div
        style={{
            position: "absolute",
            left: 0,
...
export const 智驾兜底论ProgressBar: React.FC = () => {
